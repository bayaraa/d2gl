...
"{"
  "switch(v_Flags.x){"
    ...
    "case 3:"
      "if(v_Flags.w==1)"
        "{"
          "float i=v(texture(u_Textures[v_TexIds.x],vec3(v_TexCoord,v_TexIds.y)).xyz,v_Extra.x,v_Extra.y+.1),y=v(texture(u_Textures[v_TexIds.x],vec3(v_TexCoord,v_TexIds.y)).xyz,v_Extra.x,.95);"
  ...
  "switch(v_Flags.y){"
    ...
    "case 2:"
      "float i=1.0001;"
      "vec2 n=vec2(i/u_Scale.x/v_Extra.x,i/u_Scale.y/v_Extra.y);"
      "vec2 s=n*2.,d=n*3.;"
      "if(v_TexCoord.x>s.x&&v_TexCoord.x<d.x||v_TexCoord.x<1.-s.x&&v_TexCoord.x>1.-d.x||v_TexCoord.y>s.y&&v_TexCoord.y<d.y||v_TexCoord.y<1.-s.y&&v_TexCoord.y>1.-d.y)"
        "FragColor=v_Color2;"
      "break;"
  "}"
"}"
