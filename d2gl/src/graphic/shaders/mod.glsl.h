...
"{"
  ...
  "}"
  "float i=1.00001;"
  "vec2 d=vec2(i/u_Scale.x/v_Extra.x,i/u_Scale.y/v_Extra.y),r=d*2.,s=d*3.;"
  "switch(v_Flags.y){"
    "case 1:"
      "if(v_TexCoord.x<d.x||v_TexCoord.x>1.-d.x||v_TexCoord.y<d.y||v_TexCoord.y>1.-d.y)"
        "FragColor=v_Color2;"
    "case 2:"
      "if(v_TexCoord.x>r.x&&v_TexCoord.x<s.x||v_TexCoord.x<1.-r.x&&v_TexCoord.x>1.-s.x||v_TexCoord.y>r.y&&v_TexCoord.y<s.y||v_TexCoord.y<1.-r.y&&v_TexCoord.y>1.-s.y)"
        "FragColor=v_Color2;"
      "break;"
    "case 3:"
